...
스에 맞게 재정의 하는 것’을 말한다.<br>
조상 클래스로부터 상속받은 메서드를 자손 클래스에서 그대로 사용할 수 없는 경우가
많기 때문에 오버라이딩이 필요하다.


**접근 제어자는 조상의 메서드보다 좁은 범위로만 변경할 수 없다.**<br/>
**조상의 메서드보다 더 많은 수의 예외를 선언할 수 없다.**<br/>
...
### 참고자료
- [Effective Java 3/E](http://www.yes24.com/Product/Goods/65551**28**4)